...
┌─❏﻿ *Command*
│❏ヅ${prefix}groupmenu
│❏ヅ${prefix}downloadmenu
│❏ヅ${prefix}imagemenu
│❏ヅ${prefix}makermenu
│❏ヅ${prefix}gamemenu
│❏ヅ${prefix}randomimage
│❏ヅ${prefix}randomvideo
│❏ヅ${prefix}asupanmenu
│❏ヅ${prefix}cecanmenu
│❏ヅ${prefix}animemenu
│❏ヅ${prefix}nsfwmenu
│❏ヅ${prefix}stickermenu
│❏ヅ${prefix}soundmenu
│❏ヅ${prefix}funmenu
│❏ヅ${prefix}ocrmenu
│❏ヅ${prefix}convertmenu
│❏ヅ${prefix}levelingmenu
│❏ヅ${prefix}searchmenu
│❏ヅ${prefix}apkmenu
│❏ヅ${prefix}othermenu
│❏ヅ${prefix}ownermenu
   ...
   case 'tiktok':
			...
			.then(result => {
				...
				.then(async (a) => {
					...
					Lexxy.sendMessage(from,noweem , MessageType.video, {mimetype: 'video/mp4',quoted: mek})
					})
